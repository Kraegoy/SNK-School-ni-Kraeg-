...
<div class="card">
  ...
  <form action="checkLogin_admin.php" method="post">
    <div class="field">
      ...
      <input autocomplete="off" id="logemail" placeholder="username" class="input-field" name="logemail" type="text">
    </div>
    <div class="field">
      <svg class="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="login.php" class="btn-link">Student login</a>
