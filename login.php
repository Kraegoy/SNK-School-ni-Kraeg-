...
<div class="card">
  ...
  <form action="checkLogin_stud.php" method="post">
    <div class="field">
      ...
      <input autocomplete="off" id="logemail" placeholder="Email" class="input-field" name="logemail" type="text">
    </div>
    <div class="field">
      <svg class="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
    ...
    <br>
    <a href="admin_login.php" class="btn-link">Admin login</a>
